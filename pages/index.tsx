  ...
  return (
    <>
      <Head>
        ...
        ></meta>
        <meta data-react-helmet="true" name="twitter:creator" content="Jorge Antônio Junior"></meta>
      ...
      <Layout>
        ...
        <Flex flexDir="column">
          ...
          <PrintContainer pb={["5px", "50px"]} title="Duto Redondo Para Régua">
          ...
          <PrintContainer pb={["5px", "50px"]} title="FS Duto Redondo">
            ...
            <form action="">
              <Flex justifyContent="space-evenly" flexDir={["column", "row"]}>
                <InputGroup p="0 10px">
                  <InputLeftAddon children="Volume desejado (Lítros)" />
                  <Input
          ...
          <PrintContainer pb={["5px", "50px"]} title="FS Duto Régua">
